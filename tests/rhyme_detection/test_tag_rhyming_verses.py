...
def test_transcriptions_return_correct_rhyme_tags(transcribed_poem_lines):
    ...
    #assert result[0].last_token == result[1].last_token
    assert result[0].last_token == result[0].syllables[-1]
...
def orthographic_verses():
    # %%
    poem = {
        "text_id": "1526_Ensom_no-nb_digibok_2009040303003",
        ...
        "line_3": [
            ["ei", "AEJ1"],
            ["frygter", "F R YY1 G T AX0 R"],
            ["ordets", "OO2 R AX0 T S"],
            ["gru", "G R UU1"],
        ],
        "line_4": [],
        "line_5": [],
        ...
        "line_25": [
            ["og", "OA1"],
            ["sj\u00e6len", "SJ EH1 L NX0"],
            ["skrumper", "S K R UH2 M P AX0 R"],
            ["ind", "IH0 N D"],
        ],
        "line_26": [["Livet", "L II3 V AX0"], ["slukkes", "SJ L OH2 K AX0 S"]],
        "line_27": [
            ["af", "AH0 F"],
            ["selvets", "S EH2 L V AX0 T S"],
            ["\u00f8rkenvind", "OEH1 R K AX0 N V IH3 N"],
        ],
    }
